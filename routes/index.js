...
router.post("/register",function(req,res){
    var newUser=new User({username: req.body.username,isAdmin: false,name: req.body.name,email: req.body.email,batch: req.body.py,branch: req.body.branch,job: req.body.job,ys:req.body.ys});
    User.register(newUser,req.body.password,function(err,user){
        ...
        passport.authenticate("local")(req,res,function(){
            req.flash("Registered Successfully," +User.username);
            res.redirect("/portal");
        })
    })
})
        ...
        if(err){
            ...
            Comment.create(req.body.comment,function(err,comment){
                if(err){
                    ...
                    comment.author.job=req.user.job
                    comment.save();
